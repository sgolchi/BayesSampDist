...
namespace model_fitqH0_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fitqH0");
    reader.add_event(21, 19, "end", "model_fitqH0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_fitqH0
  : public stan::model::model_base_crtp<model_fitqH0> {
private:
        int N;
        std::vector<double> p;
        std::vector<double> q;
public:
    model_fitqH0(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_fitqH0_namespace::model_fitqH0";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(phat, 
                            ...
                            beta_cdf(get_base1(q, i, "q", 1), a, a), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_fitqH0_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_fitqH0_namespace::model_fitqH0 stan_model;
#ifndef USING_R
