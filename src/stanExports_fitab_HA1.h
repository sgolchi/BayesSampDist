...
namespace model_fitab_HA1_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fitab_HA1");
    reader.add_event(41, 39, "end", "model_fitab_HA1");
    return reader;
}
#include <stan_meta_header.hpp>
class model_fitab_HA1
  : public stan::model::model_base_crtp<model_fitab_HA1> {
private:
        int N;
        std::vector<double> a;
        ...
        std::vector<double> x;
public:
    model_fitab_HA1(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_fitab_HA1_namespace::model_fitab_HA1";
        ...
        try {
            ...
            for (size_t i_0__ = 0; i_0__ < a_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "a[i_0__]", a[i_0__], 1);
            }
            current_statement_begin__ = 15;
            validate_non_negative_index("theta", "N", N);
            context__.validate_dims("data initialization", "theta", "double", context__.to_vec(N));
            theta = std::vector<double>(N, double(0));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(x, 
                            ...
                            ((get_base1(theta, i, "theta", 1) - theta0) * stan::math::sqrt(get_base1(n, i, "n", 1))), 
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(lognormal_log<propto__>(get_base1(a, i, "a", 1), ((-(alpha1) * get_base1(x, i, "x", 1)) + (alpha2 * pow(get_base1(x, i, "x", 1), 2))), sigma_a));
                if (get_base1(a, i, "a", 1) < 1) lp_accum__.add(-std::numeric_limits<double>::infinity());
                else lp_accum__.add(-lognormal_ccdf_log(1, ((-(alpha1) * get_base1(x, i, "x", 1)) + (alpha2 * pow(get_base1(x, i, "x", 1), 2))), sigma_a));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_fitab_HA1_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_fitab_HA1_namespace::model_fitab_HA1 stan_model;
#ifndef USING_R
